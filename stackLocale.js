...
const _referenceProcessor = (result, authToken) => ({
    process: (refs) => __awaiter(void 0, void 0, void 0, function* () {
        // const entryLocalesResponse = await axios.get(`https://${baseUrl}/v3/content_types/${refs._content_type_uid}/entries/${refs.uid}/locales`, { 
        //     headers: {
        //         api_key: apiKey,
        //         authtoken: authToken,
        ...
        // result.push(...locales.map((locale: any) => {
        //     const refsObject = refs;
        //     refsObject.localized = locale.localized || null;
        //     return {...refsObject, locale: locale.code};
        // }));
        result.push(refs);
    })
});
...
const main = (authtoken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Promise.all(localeData.locales.map((locale) => __awaiter(void 0, void 0, void 0, function* () {
            yield entryReferenceResolver.resolve(data, _itemRetriever, _referenceProcessor(result, authtoken), 10000, invoking_service_js_1.InvokingService.CMA, 'main', locale.code);
        })));
    ...
    fs_1.default.writeFileSync("stackLocale.json", JSON.stringify(result, null, 2), "utf-8");
});
