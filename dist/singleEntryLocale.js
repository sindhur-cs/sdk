        ...
        */
        const _itemRetriever = {
            getItem: (uid, branch, language, type, contentTypeUid) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const entryLocalesResponse = yield axios_1.default.get(`https://${baseUrl}/v3/content_types/${contentTypeUid}/entries/${uid}/locales`, { headers });
                const { locales } = yield entryLocalesResponse.data;
                return yield Promise.all(locales.map((locale) => __awaiter(void 0, void 0, void 0, function* () {
                    const entryResponse = yield axios_1.default.get(`https://app.contentstack.com/api/v3/content_types/${contentTypeUid}/entries/${uid}/descendants?locale=${locale.code}`, { headers });
...
const getVariants = (authtoken, content_type_uid, entry_uid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const variantsResponse = yield axios_1.default.get(`https://${baseUrl}/v3/content_types/${content_type_uid}/entries/${entry_uid}/variants`, {
            headers: {
                api_key: apiKey,
                authtoken,
                "Content-Type": "application/json"
        ...
        const variantsData = yield variantsResponse.data;
